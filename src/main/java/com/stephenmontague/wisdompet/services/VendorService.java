...
import com.stephenmontague.wisdompet.data.entities.VendorEntity;
import com.stephenmontague.wisdompet.data.repositories.VendorRepository;
...
public class VendorService {
    ...
    private VendorEntity translateWebToDb(Vendor vendor){
        ...
        entity.setAddress(vendor.getEmailAddress());
